...
const Footer = () => {
  return (
    <footer class="relative z-10 border-t border-stone-900 bg-white">
      <div class="container max-w-7xl mx-auto p-5 md:p-10">
        <div class="-mx-4 flex flex-col md:flex-row justify-between">
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div class="mb-10 w-full">
              <h4 class="text-dark mb-3 text-lg font-semibold">Shop All</h4>
              <ul>
                <li>
                  <a
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div class="mb-10 w-full">
              <h4 class="text-dark mb-3 text-lg font-semibold">Quick Links</h4>
              <ul>
                <li>
                  <a
                    href="javascript:void(0)"
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div class="mb-10 w-full">
              <h4 class="text-dark mb-3 text-lg font-semibold">Follow Us On</h4>
              <div class="mb-6 flex items-center">
                <a
                  href="javascript:void(0)"
                  class="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-stone-500 sm:mr-4 lg:mr-3 xl:mr-4"
                >
                  <svg
                    width="8"
                    height="16"
